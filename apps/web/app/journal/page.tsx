...
const timelineEvents = [
  { id: 1, year: 2022, title: "The Spatial Spark", slug: "spatial-spark", type: "thought" },
  { id: 2, year: 2024, title: "Building the Neural Engine", slug: "neural-engine", type: "project" },
  { id: 3, year: 2025, title: "The Atlas Reveal", slug: "atlas-reveal", type: "travel" },
  { id: 4, year: 2026, title: "Synthesis & The Future", slug: "synthesis", type: "reflection" },
];

const journalEntries = [
  { slug: "spatial-spark", title: "The Spatial Spark: When Interfaces Disappear", date: "Jan 12, 2022", abstract: "An exploration into how we can move past screen-bound interaction into true spatial computing.", readTime: "5 min read", location: "San Francisco", type: "Thoughts" },
  { slug: "neural-engine", title: "Building the Neural Engine", date: "Mar 04, 2024", abstract: "Technical teardown of optimizing local LLMs to preserve zero-shot reasoning on consumer hardware.", readTime: "12 min read", location: "New York", type: "Current Affairs" },
  { slug: "atlas-reveal", title: "The Atlas Reveal", date: "Nov 15, 2025", abstract: "Why we need to preserve human memory spatially, and how Atlas accomplishes this.", readTime: "8 min read", location: "Paris", type: "Travel" },
  { slug: "synthesis", title: "Synthesis & The Future", date: "May 22, 2026", abstract: "Looking forward at the intersection of AI, spatial UX, and digital legacy.", readTime: "6 min read", location: "Tokyo", type: "Reflections" },
];
          ...
          <div className="lg:w-2/3 relative flex justify-center py-24">
            ...
            <div className="relative z-10 flex flex-col gap-32 w-full max-w-md">
              {timelineEvents.map((event, idx) => (
                ...
                >
                  <span className="font-mono text-xs text-[var(--secondary)]">{event.year}</span>
                  <Link href={`/journal/${event.slug}`} className="group flex flex-col gap-1">
                    ...
                    <span className="font-sans text-sm text-[var(--secondary)] uppercase tracking-wider">{event.type}</span>
                  </Link>
                </motion.div>
              ))}
            </div>
